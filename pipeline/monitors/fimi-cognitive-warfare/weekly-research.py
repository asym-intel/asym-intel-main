...
try:
    ...
    log_incident(monitor="fimi-cognitive-warfare", stage="weekly-research", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="fimi-cognitive-warfare", stage="weekly-research", incident_type="schema_violation",
