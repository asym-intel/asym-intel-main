#!/usr/bin/env python3
"""
FCW Collector — GitHub Actions script
Calls Perplexity API with the FCW Collector prompt,
...
OUT_DIR   = pathlib.Path("pipeline/monitors/fimi-cognitive-warfare/daily")
...
PROMPT_FILE = pathlib.Path(
    "pipeline/monitors/fimi-cognitive-warfare/fcw-collector-api-prompt.txt"
)
...
if meta.get("monitor_slug") != "fimi-cognitive-warfare":
    errors.append(f"monitor_slug is '{meta.get('monitor_slug')}' — expected 'fimi-cognitive-warfare'")
