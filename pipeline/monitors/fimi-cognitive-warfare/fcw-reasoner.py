...
Feeds all three as context to sonar-pro for attribution chain
...
PROMPT_FILE = pathlib.Path("pipeline/monitors/fimi-cognitive-warfare/fcw-reasoner-api-prompt.txt")
...
try:
    ...
    log_incident(monitor="fimi-cognitive-warfare", stage="reasoner", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="fimi-cognitive-warfare", stage="reasoner", incident_type="schema_violation",
