...
Feeds all three as context to sonar-pro for deterioration pattern
...
IDENTITY_FILE = pathlib.Path("docs/identity/wdm-identity.md")
identity_content = ""
...
PROMPT_FILE = pathlib.Path("pipeline/monitors/democratic-integrity/wdm-reasoner-api-prompt.txt")
...
try:
    ...
    log_incident(monitor="democratic-integrity", stage="reasoner", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="democratic-integrity", stage="reasoner", incident_type="schema_violation",
