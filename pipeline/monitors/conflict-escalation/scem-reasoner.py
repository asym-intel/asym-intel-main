...
try:
    ...
    log_incident(monitor="conflict-escalation", stage="reasoner", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="conflict-escalation", stage="reasoner", incident_type="schema_violation",
