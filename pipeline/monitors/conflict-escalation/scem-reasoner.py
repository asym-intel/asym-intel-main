...
- Apply SCEM evidentiary thresholds:
...
{{
  ...
  "analyst_briefing": "<200-300 word summary for the SCEM Analyst. Cover: key attribution changes recommended, important linkages detected, actor posture changes, cross-monitor flags. Written in cold analytical register.>"
}}"""
