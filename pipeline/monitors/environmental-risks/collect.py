#!/usr/bin/env python3
"""
ERM Collector — GitHub Actions script
Calls Perplexity API with the ERM Collector prompt,
...
OUT_DIR   = pathlib.Path("pipeline/monitors/environmental-risks/daily")
...
PROMPT_FILE = pathlib.Path(
    "pipeline/monitors/environmental-risks/erm-collector-api-prompt.txt"
)
...
_calib_path = f"methodology/environmental-risks-eeas-{_calib_year}.md"
...
if raw_content is None:
    log_incident(monitor="environmental-risks", stage="collector", incident_type="api_failure",
...
try:
    ...
    log_incident(monitor="environmental-risks", stage="collector", incident_type="json_parse_error",
...
if meta.get("monitor_slug") != "environmental-risks":
    errors.append(f"monitor_slug is '{meta.get('monitor_slug')}' — expected 'environmental-risks'")
...
if errors:
    log_incident(monitor="environmental-risks", stage="collector", incident_type="schema_violation",
