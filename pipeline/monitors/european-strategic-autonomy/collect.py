...
if raw_content is None:
    log_incident(monitor="european-strategic-autonomy", stage="collector", incident_type="api_failure",
...
try:
    ...
    log_incident(monitor="european-strategic-autonomy", stage="collector", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="european-strategic-autonomy", stage="collector", incident_type="schema_violation",
