...
try:
    ...
    log_incident(monitor="european-strategic-autonomy", stage="reasoner", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="european-strategic-autonomy", stage="reasoner", incident_type="schema_violation",
