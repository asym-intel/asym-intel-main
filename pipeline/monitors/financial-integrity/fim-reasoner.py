...
try:
    ...
    log_incident(monitor="financial-integrity", stage="reasoner", incident_type="json_parse_error",
...
if errors:
    log_incident(monitor="financial-integrity", stage="reasoner", incident_type="schema_violation",
