...
## CURRENT ARCHITECTURE — European Strategic Autonomy Monitor (updated 2026-04-01)
...
cat > content/monitors/european-strategic-autonomy/${PUBLISH_DATE}-weekly-brief.md << MDEOF
---
title: "European Strategic Autonomy Monitor — W/E {DATE}"
date: ${PUBLISH_DATE}T19:00:00Z
...
git add static/monitors/european-strategic-autonomy/data/
git add content/monitors/european-strategic-autonomy/
git commit -m "data(ESA): weekly pipeline — Issue [N] W/E ${PUBLISH_DATE}"
...
- Data: https://asym-intel.info/monitors/european-strategic-autonomy/data/report-latest.json
- Internal spec: asym-intel/asym-intel-internal/methodology/european-strategic-autonomy-full.md
