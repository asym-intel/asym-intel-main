...
The [live dashboard](https://asym-intel.info/monitors/ai-governance/dashboard.html) and [JSON data feed](https://asym-intel.info/monitors/ai-governance/data/report-latest.json) have been updated to Issue 4 (W/E 10 April 2026).

*Published by AIM Publisher Bot.*
